                                                                                      ...
                                                                                      child: ListView(
                                                                                        children: [
                                                                                          ...
                                                                                          TextFormField(
                                                                                            ...
                                                                                            keyboardType: TextInputType.text,
                                                                                            decoration: InputDecoration(label: Text('enterPaotiNumber'.tr()), contentPadding: const Pad(top: 0, bottom: 0, left: 10), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)), enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
                                                                                          ),
                                                                                          const SizedBox(
                                                                                            height: 10,
                                                                                          ),
                                                                                            ...
                                                                                            onTap: () async {
                                                                                              if (form.currentState!.validate()) {
                                                                                                ...
                                                                                                if (ref.watch(qualityImage) == null) {
                                                                                                  ...
                                                                                                  ref.watch(endTripProvider(tripRequestId: '${dataList![index]?.id ?? 0}', kantaWeight: '${weightController.text.toString()}', bags: "${bagsController.text.toString()}", kantaImage: img64, qualityImage: img642, paotiImage: base64Encode(File(ref.watch(paotiImage)?.path ?? "").readAsBytesSync()), paotiNumber: paotiController.text).future).then((value) {
                                                                                                    hideLoader(context);
                                                            ...
                                                            : Text(
                                                                ...
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                                                                style: TextStyle(
                                                                    color: dataList?[index]?.status?.toInt() ==
                                                                            0
                                                                        ? Colors
                                                                            .red
                                                                        : ColorConstants
